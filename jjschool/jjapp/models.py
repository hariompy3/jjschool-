...
class Result(models.Model):
    ...
    assignment = models.ForeignKey(TeacherSubjectAssignment, on_delete=models.CASCADE, related_name='results')
    marks = models.FloatField()
    grade = models.CharField(max_length=2)
    comments = models.TextField(blank=True)

    class Meta:
        unique_together = ('student', 'exam', 'assignment')

    def __str__(self):
        return f"{self.student} - {self.exam} - {self.assignment.subject}"
